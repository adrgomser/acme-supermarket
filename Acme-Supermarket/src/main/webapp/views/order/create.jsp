...
<form:form action="order/consumer/create.do" modelAttribute="order">
	...
	<br />
	<form:label path="paise">
		<spring:message code="order.paise" />:
	</form:label>
	<form:select id="paises" path="paise">
		<form:option value="0" label="----" />		
		<form:options items="${paises}" itemValue="id" itemLabel="title" />
	</form:select>
	<form:errors cssClass="error" path="paise" />
	<br />
