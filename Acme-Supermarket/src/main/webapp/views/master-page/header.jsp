		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="paise/administrator/list.do"><spring:message code="master.page.administrator.paise" /></a></li>					
		...
		<security:authorize access="hasRole('CONSUMER')">
			<li><a class="fNiv"><spring:message	code="master.page.customer" /></a>
				...
				<li><a href="order/consumer/list.do"><spring:message code="master.page.customer.order" /></a></li>
									<li><a href="paise/consumer/list.do"><spring:message code="master.page.administrator.paise" /></a></li>					
				</ul>
			</li>
		</security:authorize>
